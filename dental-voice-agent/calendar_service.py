...
class CalendarService:
    ...
    def get_available_slots(self, date_str: str, duration_minutes: int) -> list[str]:
        ...
        Example return: ["9:00 AM", "10:30 AM", "2:00 PM"]
        """
        ...
        while slot_start + timedelta(minutes=duration_minutes) <= day_end:
            ...
            buffered_end = slot_end + timedelta(minutes=15)  # 15-min buffer between appts
            is_free = all(
        ...
        return available[:6]  # cap at 6 options to keep conversation manageable
